...
* Meanwhile, when data gets loaded into S3 bucket, Firehose delivery stream executes (COPY Command)(https://github.com/DefoeZhang/data-engineering-aws-credit-card-transactions/blob/main/code/CopyCommand.txt) to copy data from S3 bucket to Redshift. Redshift will use S3 manifest files created by Firehose to look for the S3 data files that should be copied and then copy the corresponding data into Redshift table.
...
![alt text](https://github.com/DefoeZhang/data-engineering-aws-credit-card-transactions/blob/main/image/glue%20jub%20mapping.png)
